...
export default function Article3() {
    const[handsup,setHandsup]=useState(55)
    return (
        <div>
       ...
       <p className='avtr'></p>
       <p className='atxt2'>Jhon Doe <br/> <span className='opc'>Jan 9 2021. 05 mins read</span> <span className='icons'><i className="fa fa-instagram"></i> <i className="fa fa-twitter"></i> <i className="fa fa-youtube"></i> <i className="fa fa-facebook"></i> </span> </p>
       ...
       <hr/>
       <p className='avtr'></p>
       <p className='atxt3'> Written By <br/> Jhon Doe <br/> <span className='opc'>Jan 9 2021. 05 mins read</span></p>
       <hr/>
       </div>
